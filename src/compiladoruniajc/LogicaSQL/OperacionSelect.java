 ...
 * @author George
 */
public class OperacionSelect {

    String strInstruccionSQL = "";

    public OperacionSelect() {
    }
    ...
    public OperacionSelect(String CadSQL) {
    ...
    public void analizar() {
        ...
        switch (tokens.intTipoToken) {
            case 11:
                ...
                if (tokens.intTipoToken == tokens.ASTERISCO) {
                ...
                if (tokens.intTipoToken == tokens.DELIMITADOR && tokens.token.toString().toLowerCase().equals(";")) {
                    ...
                    mensaje_SBDD("\n\n Se seleccionan TODOS los registros de  tabla " + strNombreTabla);
                    //aqui se haria el SELECT la tabla que indico el usuario
            ...
            case 6:
                ...
                if (tokens.intTipoToken == tokens.DELIMITADOR && tokens.token.toString().toLowerCase().equals(";")) {
                    //Cambiarnos a la primera ficha
                    JICompiladorSQL.jTabbedPane.setSelectedIndex(0);
                    mensaje_SBDD("\n\n Se seleccionan TODOS los registros de la COLUMNA " + colunm + " pertenecientes a la tabla " + strNombreTabla);
                    //aqui se haria el SELECT la tabla que indico el usuario
                    mensaje_SBDD("\n Operacion SELECT realizada con exito.");
                    return;
                }   //Fin de checkar si es ;
    ...
    public void mensaje_SBDD(String msg) {
        JICompiladorSQL.txt_area_compi.append(msg);
    }
